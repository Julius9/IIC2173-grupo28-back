...
var IPinfoWrapper = (function () {
    function IPinfoWrapper(token, cache, timeout) {
        ...
        this.token = token;
        this.countries = utils_1.countries;
        this.countriesFlags = utils_1.countriesFlags;
        this.countriesCurrencies = utils_1.countriesCurrencies;
        this.continents = utils_1.continents;
        this.euCountries = utils_1.euCountries;
